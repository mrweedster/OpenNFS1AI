...
namespace OpenNFS1.Vehicles
{
	...
	class VehicleDescription
	{
		...
		// Returns all vehicles that belong to the same class as the given descriptor.
		public static List<VehicleDescription> SameClass(VehicleDescription v)
		{
			return Descriptions.FindAll(d => d.Class == v.Class);
		}
