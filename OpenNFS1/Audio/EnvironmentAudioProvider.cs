...
namespace OpenNFS1.Audio
{
    class EnvironmentAudioProvider
    {
        ...
        private EnvironmentAudioProvider()
        {
            ...
            _collisions.Add(LoadWav(BasePath + "/Environment/collision1"));
            _collisions.Add(LoadWav(BasePath + "/Environment/collision2"));
            _collisions.Add(LoadWav(BasePath + "/Environment/collision3"));
        }
