...
namespace OpenNFS1.UI.Screens
{
    class BaseUIScreen
    {
        ...
        public BaseUIScreen()
        {
			...
			using (var stream = File.OpenRead("Content\\splash-screen.jpg"))
				_background = Texture2D.FromStream(Engine.Instance.GraphicsDevice, stream);
        }
		...
		public virtual void Draw()
		{
			...
			if (_background != null)
			{
				Engine.Instance.SpriteBatch.Draw(_background, new Rectangle(0, 0, GameConfig.ResX, GameConfig.ResY), Color.FromNonPremultiplied(50, 50, 50, 255));
			}
			_currentLine = 5;
		}
